...
my $r1 = IO::File->new("../../Extra/MF/MF_Pre_Definition_Matrix.dat","r") or die "Can not open file to read from;\nRun '2.7.MF_Definition_Matrix_Construction_preparation.pl' first!\n";
...
open(my $w, '>', "../../Extra/MF/MF_Pre_Definition_Matrix_temp.dat") or die "Could not open file to write in\n";
...
my $r3 = IO::File->new("../../Extra/MF/MF_Pre_Definition_Matrix_temp.dat","r") or die "Could not open file to read from\n";
open(my $w1, '>', "../../Matrices/MF_Definition_Matrix.mtrx") or die "Could not open file to write in\n";
