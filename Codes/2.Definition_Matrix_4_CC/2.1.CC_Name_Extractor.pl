# This code extracts full name of GO terms included in CC ontology (Please read the read-me file before use!)
use IO::File;
...
open(my $w, '>', "../../Extra/CC/CC_GO_name.dat") or die "Can not open file to write in\n";
