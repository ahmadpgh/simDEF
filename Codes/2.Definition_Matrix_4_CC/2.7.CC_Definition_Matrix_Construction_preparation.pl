# This code prepares (extended) definitions of GO terms included in CC ontology for their definition vectors (Please read the read-me file before use!)
use IO::File;

my $r1 = IO::File->new("../../Extra/CC/CC_Extended_Definition.dat","r") or die "Can not open file to read from;\nRun '2.6.CC_Extended_Definition_Construction.pl' first!\n";
...
open(my $w, '>', "../../Extra/CC/CC_Pre_Definition_Matrix.dat") or die "Could not open file to write in\n";
